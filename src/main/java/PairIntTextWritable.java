...
public class PairIntTextWritable implements WritableComparable {
    public IntWritable first;
    public Text second;

    public PairIntTextWritable(){
        this.first = new IntWritable(0);
        this.second = new Text("");
    }

    public PairIntTextWritable(IntWritable a, Text b){
        this.first = a;
        this.second = b;
    ...
    public int compareTo(Object o) {
        PairIntTextWritable other = (PairIntTextWritable) o;
